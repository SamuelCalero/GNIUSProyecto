...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a href="?path=Asesor&c=DatosEmprendedores&a=inicio" class="nav-link active" id="" type="button">Emprendedores</a>
        <a href="?path=Asesor&c=DatosEmpresas&a=inicio" class="nav-link" id="" type="button">Empresas</a>
    </div>
</nav>
        ...
        <div class="card-content table-responsive">
            <table id="tabla_emprendedores" class="table table-sm table-striped table-hover">
                <thead class="text-white color-primary">
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Nombre Emprendedor</th>
                        <th scope="col">Correo</th>
                        <th scope="col">Telefono</th>
                        <th width="10"></th>
                    </tr>
                </thead>
                <tbody id="datos_emprendedores">
                </tbody>
            </table>
            <br>
        </div>
...
<?php require_once('Views/Asesor/Datos/Modal_emprendedor.php');?>         
<?php require('Views/Asesor/Lib/footer.php');?> 
<script src="Js/Asesor/datos-emprendedores.js"></script>
