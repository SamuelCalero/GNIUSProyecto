...
class pdf extends FPDF
{
    ...
    $fpdf->SetTitle("Reporte Empresas");
    $fpdf->Cell(80);
    $fpdf->Cell(35,10,'Reporte de Empresas - Formulario',0,0,'C');
    $fpdf->Ln(10);
    ...
    $fpdf->Cell(100,8,"Nombre Empresa",1,0,"C",1);
    $fpdf->Cell(75,8,"Rubro",1,0,"C",1);
    ...
    foreach($stmt as $fll){
        $fpdf->Cell(10,10,$fll['id_empresas'],0,0,"L",1);
        $fpdf->Cell(15,10,$fll['id_formulario'],0,0,"L",1);
        $fpdf->Cell(100,10,utf8_decode($fll['nombre_empresa']),0,0,"L",1);
        $fpdf->Cell(75,10,utf8_decode($fll['rubro']),0,0,"L",1);
        $fpdf->Ln(8);
    }
